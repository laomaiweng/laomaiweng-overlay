...
# Gentoo package is misnamed, should be sbsigntool*s*
MY_P="${P/-/s-}"

DESCRIPTION="Utilities for signing and verifying files for UEFI Secure Boot"
HOMEPAGE="https://git.kernel.org/cgit/linux/kernel/git/jejb/sbsigntools.git/"
SRC_URI="https://git.kernel.org/pub/scm/linux/kernel/git/jejb/sbsigntools.git/snapshot/${MY_P}.tar.gz
...
PATCHES=(
	"${FILESDIR}/${MY_P}"-openssl-1.1.0-compat.patch
)
...
src_unpack() {
	default
	mv "${WORKDIR}"/lib/ccan "${S}"/lib || die "failed to move lib/ccan"
}
