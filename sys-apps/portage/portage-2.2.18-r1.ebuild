...
PATCHES=("${FILESDIR}/portage-2.2.18-emerge-use-colors.patch"
	"${FILESDIR}/portage-2.2.18-emerge-attr-colors.patch"
	"${FILESDIR}/portage-2.2.18-emerge-repo-colors.patch"
)
