...
<table>
  ...
  <tr><td rowspan=1>media-libs</td><td>opencolorio</td><td>bugfix (ported from upstream bug <a href="https://github.com/imageworks/OpenColorIO/issues/369">#369</a>), due for submission to Portage tree</td><td>Portage</td></tr>
